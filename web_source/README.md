...
## Quick Controls added in v1.0.3

The main Home screen now has a **Quick Controls** panel. These buttons bypass the AI agent and do not use Accessibility to locate or scroll UI elements.

- Lock — Device Admin protected
- Wake — Android screen wake request
- Flash ON / OFF — CameraManager torch API
- Alert — Android ToneGenerator
- Vibrate — Android Vibration API
- Volume 100% — existing direct volume service
- Device Admin — opens Android's explicit Device Admin activation screen

The Lock button requires the user to explicitly enable Device Admin. The Flash buttons require Camera permission.
